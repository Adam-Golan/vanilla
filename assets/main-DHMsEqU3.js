...
const _Basis = class _Basis extends HTMLElement {
  ...
  constructor(config) {
     ...
     */
    __publicField(this, "cElem", document.createElement.bind(document));
    /**
     * Get an element by its id.
     * @param id The id of the element to retrieve.
     * @returns The element with the given id, or null if it doesn't exist.
     */
    __publicField(this, "idElem", /* @__PURE__ */ __name((id) => this.querySelector(`#${id}`), "idElem"));
    /**
     * Get elements by their "name" attribute.
     * @param name The value of the "name" attribute to search for.
     * @returns A list of elements with a "name" attribute equal to the given value.
     */
    __publicField(this, "nmElem", /* @__PURE__ */ __name((name) => this.querySelectorAll(`[name="${name}"]`), "nmElem"));
    /**
     ...
     */
    __publicField(this, "clsElem", this.getElementsByClassName);
    /**
     ...
     */
    __publicField(this, "tagElem", this.getElementsByTagName);
    this.config = config;
...
const _Module = class _Module extends Basis {
  ...
  constructor(config, parentState) {
    super(config);
    __publicField(this, "state", new State());
    this.config = config;
    this.parentState = parentState;
    addMeta(this, "module");
  }
...
const _Page = class _Page extends Basis {
  ...
  constructor(texts, appState) {
    ...
    __publicField(this, "layout", "single_column");
...
Collapsible = __decorateClass$z([
  ComponentDecorator
], Collapsible);
const _BaseDropdown = class _BaseDropdown extends Component {
  constructor(list = [], cb) {
    super(list);
    __publicField(this, "dialog", this.cElem("dialog"));
    this.list = list;
    this.cb = cb;
...
SelectDropdown = __decorateClass$y([
  ComponentDecorator
], SelectDropdown);
...
let FilterDropdown = (_h = class extends SelectDropdown {
  constructor() {
    super(...arguments);
    __publicField(this, "filteredList");
  }
  filter(val) {
...
FilterDropdown = __decorateClass$x([
  ComponentDecorator
], FilterDropdown);
...
let MenuDropdown = (_i = class extends BaseDropdown {
  constructor(list) {
    super(list, () => null);
    __publicField(this, "createItem", /* @__PURE__ */ __name((item) => item, "createItem"));
    this.list = list;
  }
}, __name(_i, "MenuDropdown"), _i);
MenuDropdown = __decorateClass$w([
  ComponentDecorator
], MenuDropdown);
...
const _Modal = class _Modal {
  ...
  closeModal() {
    ...
    setTimeout(() => {
      var _a2;
      return (_a2 = this.deleteFn) == null ? void 0 : _a2.call(this);
    }, 500);
  }
};
__name(_Modal, "Modal");
...
let Link = (_l = class extends Component {
  ...
  init() {
    ...
    this.onclick = () => {
      this.navigate(this.texts.href);
    };
    if (this.texts.title) this.title = this.texts.title;
    if ((_a2 = this.texts.img) == null ? void 0 : _a2.length) {
...
let Progress = (_n = class extends Component {
  constructor(max) {
    super(max);
    __publicField(this, "progress", this.appendChild(this.cElem("progress")));
    this.max = max;
...
let Toast = (_s = class extends HTMLElement {
  constructor(listener, event, msg, ref, type = "general", timeout = 5e3) {
    super();
...
const _FormComponent = class _FormComponent extends Component {
  constructor(props) {
    ...
    __publicField(this, "formCb");
    this.props = props;
  }
  init() {
    var _a2;
    this.hasError = !!(this.props.required && ((_a2 = this.props.error) == null ? void 0 : _a2.length));
  ...
  createFormGroup(inpType) {
    ...
    if ((_a2 = this.props.label) == null ? void 0 : _a2.length) this.setLabel(label) && children.unshift(label);
    this.setAccessibility(children);
    fieldset.append(...children);
    if ((_b2 = this.props.error) == null ? void 0 : _b2.length) fieldset.append(this.createError());
    return fieldset;
  }
  // ---------------------------------------------------------------------------------------------
  // Elements Methods.
  ...
  setField() {
    ...
    if (((_a2 = this.props.placeholder) == null ? void 0 : _a2.length) && !(this.field instanceof HTMLSelectElement)) this.field.placeholder = this.props.placeholder;
  ...
  setAccessibility(children) {
    var _a2;
    if ((_a2 = this.props.label) == null ? void 0 : _a2.length) this.field.setAttribute("aria-labelledby", `${this.props.name}Label`);
  ...
  checkError() {
    var _a2, _b2, _c2;
    if ((_a2 = this.props.error) == null ? void 0 : _a2.length) {
      this.hasError = !!(this.props.required && ((_b2 = this.props.error) == null ? void 0 : _b2.length) && (!this.value.length || this.value === "off"));
      (_c2 = this.clsElem("form-output").item(0)) == null ? void 0 : _c2.classList[this.hasError ? "add" : "remove"]("show");
    }
  }
  // ---------------------------------------------------------------------------------------------
  // Interface Methods.
  ...
  focus() {
    var _a2;
    (_a2 = this.field) == null ? void 0 : _a2.focus();
  }
};
...
const _FormKeyboardComponent = class _FormKeyboardComponent extends FormComponent {
  reset() {
    var _a2;
    super.reset();
    if ((_a2 = this.props.placeholder) == null ? void 0 : _a2.length) this.field.placeholder = this.props.placeholder;
  }
};
...
Autocomplete = __decorateClass$j([
  ComponentDecorator
], Autocomplete);
...
let Radio = (_z = class extends FormComponent {
  createMe() {
    ...
    const fieldset = this.cElem("fieldset"), legend = this.cElem("legend"), children = [legend];
...
let Select = (_B = class extends FormMouseComponent {
  createMe() {
    ...
    if ((_a2 = this.props.placeholder) == null ? void 0 : _a2.length) this.field.innerHTML = `<option disabled selected>${this.props.placeholder}</option>`;
    ...
    if (!((_b2 = this.props.placeholder) == null ? void 0 : _b2.length)) setTimeout(() => this.field.dispatchEvent(new Event("input", { bubbles: true })));
    return fieldset;
  }
  reset() {
...
let Form = (_E = class extends Module {
  constructor(map, btns) {
    ...
    __publicField(this, "appBtns", []);
    __publicField(this, "submitable", false);
    this.map = map;
    this.btns = btns;
  }
  init() {
  ...
  createLegend() {
    var _a2;
    if ((_a2 = this.map.legend) == null ? void 0 : _a2.length) {
    ...
    return this.fields = Object.values(this.map.fields).map((obj) => {
      ...
      switch (obj.type) {
        case "input":
          ...
          if ((_a2 = obj.props.multiplyBy) == null ? void 0 : _a2.length) {
            setTimeout(() => {
      ...
      field.formCb = () => {
        var _a3;
        this.query[obj.props.name] = `${field.value} ${((_a3 = obj.props.dataset) == null ? void 0 : _a3.unit) ?? ""}`.trim();
        this.checkForm();
      };
      return field;
    });
  ...
  cleanQuery() {
    var _a2;
    for (const key of Object.keys(this.query)) if (!((_a2 = this.query[key]) == null ? void 0 : _a2.length)) delete this.query[key];
    return true;
  }
  // Form reset.
  resetForm() {
  ...
  addRefListener(ref, toClone) {
    if (ref) {
      if (!ref.value) ref == null ? void 0 : ref.onInput("1");
      ref.addEventListener("input", () => this.multiply(ref, toClone));
    }
  }
  multiply(ref, toClone) {
    if (!(ref == null ? void 0 : ref.value)) return;
    let idx = -1;
    ...
    const newFields = [];
    for (let ctx = 1; ctx <= +(ref == null ? void 0 : ref.value); ctx++) {
      const props = structuredClone(toClone.props);
      props.name += `${ctx}`;
      const field = new Input(props);
      field.formCb = () => {
        var _a2;
        this.query[props.name] = `${field.value} ${((_a2 = props.dataset) == null ? void 0 : _a2.unit) ?? ""}`.trim();
        this.checkForm();
      };
      field.onchange = () => {
        var _a2, _b2;
        this.query[props.name] = ((_a2 = field.value) == null ? void 0 : _a2.length) ? `${field.value} ${((_b2 = props.dataset) == null ? void 0 : _b2.unit) ?? ""}` : "";
        this.checkForm();
      };
...
let Hero = (_I = class extends Module {
  ...
  init() {
    ...
    if (((_a2 = this.texts.anchor) == null ? void 0 : _a2.text) && ((_b2 = this.texts.anchor) == null ? void 0 : _b2.href))
      this.append(new Link(this.texts.anchor, () => {
        var _a3;
        return this.pageState.publish(StateKeys.navigate, (_a3 = this.texts.anchor) == null ? void 0 : _a3.href);
      }));
  }
}, __name(_I, "Hero"), _I);
Hero = __decorateClass$7([
  ModuleDecorator
], Hero);
...
let Row = (_K = class extends Component {
...
let Table = (_L = class extends Module {
  constructor(data) {
    super(data);
    this.data = data;
...
let AboutUs = (_M = class extends Page {
  async init() {
...
let ContactUs = (_N = class extends Page {
  async init() {
...
let Counter = (_O = class extends Component {
  constructor() {
    super(...arguments);
    __publicField(this, "_value", 0);
    __publicField(this, "field", this.cElem("span"));
  }
  set value(newVal) {
...
let Home = (_P = class extends Page {
  init() {
...
const _Navigation = class _Navigation {
  ...
  constructor(state, ref, pages, basePath = "/") {
    __publicField(this, "loader", new Loader({}));
    __publicField(this, "currentPage");
    __publicField(this, "cachedPages", /* @__PURE__ */ new Map());
    __publicField(this, "i18n", new Language());
  ...
  subscribes() {
    ...
    window.addEventListener("popstate", () => {
      ...
      this.history[this.history.length - 2] ? this.loadingProcess(this.history[this.history.length - 2]) : this.fisrtLoad();
    });
  ...
  */
  ...
  loadingProcess(path) {
    var _a2;
    if (path.slice(1).remove("-") === ((_a2 = this.currentPage) == null ? void 0 : _a2.id)) return;
  ...
  navigationLogic(path) {
    ...
    if (this.cachedPages.has(path)) {
      ...
      if (Page2.name === ((_a2 = this.currentPage) == null ? void 0 : _a2.constructor.name) && !location.pathname.includes(path)) return;
      const texts = this.i18n.getTexts(path.remove(/(\-|\/)/));
      this.cachedPages.set(path, new Page2(texts, this.state));
      this.currentPage = this.cachedPages.get(path);
    }
  }
  // ------------------------------
...
const _State = class _State {
  ...
  publish(name, ...args) {
    var _a2;
    (_a2 = this.subscribers.get(name)) == null ? void 0 : _a2.forEach((fn) => fn(...args));
  }
  /**
   ...
   */
  subscribe(name, fn) {
    this.subscribers.has(name) ? this.subscribers.get(name).push(fn) : this.subscribers.set(name, [fn]);
  }
  /**
...
const _Main = class _Main {
  ...
  constructor() {
    // App element.
    __publicField(this, "app", document.getElementById("app") ?? this.createApp());
    // Services.
    __publicField(this, "appState", new State());
    __publicField(this, "navigation", new Navigation(this.appState, this.app, appConfig.routes));
    setMetaTags(appConfig.meta);
    if (appConfig.OGCard) setOpenGraphTags(appConfig.OGCard);
    this.navigation.importTexts().then((_) => this.init());
  }
  /**
  ...
  subscribes() {
    const modals = {};
    this.appState.subscribe(StateKeys.openModal, (key, content) => modals[key] = new Modal(this.app.append, content, () => delete modals[key]));
  }
};
__name(_Main, "Main");
let Main = _Main;
